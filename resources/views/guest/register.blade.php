...
<div class="container">
  <div class="row mt-2 mb-4">
    <div class="col-4 mx-auto p-4 rounded" style="background-color:#FFFFFF">
      ...
      <form action="/register" method="post">
        ...
        <div class="mt-3 form-input">
          <i class="fa-solid fa-key icon"></i>
          <input type="password" class="form-control input @error('confirmPassword') is-invalid @enderror" 
        ...
        <div class="mt-3 form-input">
          ...
          <input type="number" class="form-control input @error('nip') is-invalid @enderror" 
        ...
        <select class="form-select mt-3 @error('dinas_id') is-invalid @enderror" aria-label="Default select example" 
