            ...
            <div class="col">
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                    ...
                    <div class="mt-2">
                        <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#tambahUser">
                            Tambah User<i class="fa-solid fa-plus ms-2"></i></button>
                    </div>
                </div>
                <div class="table-responsive">
                    ...
                    <tbody class="text-center">
                        ...
                        <td><button type="button" class="badge bg-info border-0 mx-auto">edit</button>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button type="submit" class="btn btn-primary" id="formSubmit">Simpan</button>
      </div>
      </form>
    </div>
  </div>
