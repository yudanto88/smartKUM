                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col text-start ps-0">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col ps-0">
                                                                        <p class="mb-0" style="text-align: justify;">diajukan oleh {{$draft->staffUndang->admin->draft->user->name}}</p>
                                                                    </div>
                                                                </div>
                                                                <div class="row">
                                                                    <div class="col-1 pe-0">
                                                                    ...
                                                                    <div class="col ps-0">
                                                                        <p style="text-align: justify;">{{$draft->staffUndang->admin->draft->keterangan}}</p>
                                                                    </div>
                                                                </div>
                                                        ...
                                                        <div class="row border-top">
                                                            ...
                                                            <div class="col text-start ps-0">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col ps-0">
                                                                        <p class="mb-0" style="text-align: justify;">{{$draft->staffUndang->admin->status}} oleh {{$draft->staffUndang->admin->validated}}</p>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col ps-0">
                                                                        <p style="text-align: justify;">{{ $draft->staffUndang->admin->keterangan }}</p>
                                                                    </div>
                                                                </div>
                                                                @endif
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col ps-0">
                                                                        <p style="text-align: justify;">{{ $draft->staffUndang->admin->keterangan_penolakan }}</p>
                                                                    </div>
                                                                </div>
                                                                @endif
                                                        ...
                                                        <div class="row border-top">
                                                            ...
                                                            <div class="col text-start ps-0">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col ps-0">
                                                                        <p class="mb-0" style="text-align: justify;">{{$draft->kabag->status}}</p>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col ps-0">
                                                                        {{$draft->kabag->status}} oleh {{$draft->kabag->validated}}
                                                                    </div>
                                                                </div>
                                                                @endif
                                                                @endif
                                                                ...
                                                                @elseif($draft->kabag->status == 'ditolak oleh sekda' || $draft->kabag->status == 'ditolak oleh walikota')
                                                                <div class="row">
                                                                    <div class="col-1 pe-0">
                                                                        <i class="fa-solid fa-angle-right"></i>
                                                                    </div>
                                                        ...
                                                        <div class="row border-top">
                                                            ...
                                                            <div class="col text-start ps-0">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col ps-0">
                                                                        <p class="mb-0" style="text-align: justify;">{{$draft->kabag->kepalaDinas->status}}</p>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col ps-0">
                                                                        <p style="text-align: justify;">{{$draft->kabag->kepalaDinas->keterangan}}</p>
                                                                    </div>
                                                                </div>
                                                                @endif
                                                                @endif
                                                        ...
                                                        <div class="row border-top">
                                                            ...
                                                            <div class="col text-start ps-0">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col ps-0">
                                                                        <p class="mb-0" style="text-align: justify;">{{$draft->kabag->kepalaDinas->sekda->status}}</p>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col ps-0">
                                                                        <p style="text-align: justify;">{{$draft->kabag->kepalaDinas->sekda->keterangan}}</p>
                                                                    </div>
                                                                </div>
                                                        ...
                                                        <div class="row border-top">
                                                            ...
                                                            <div class="col text-start ps-0">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col ps-0">
                                                                        <p class="mb-0" style="text-align: justify;">{{$draft->kabag->kepalaDinas->sekda->walikota->status}}</p>
                                                                    </div>
                                                                </div>
