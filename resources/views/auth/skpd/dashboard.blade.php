                                ...
                                <div class="modal-dialog">
                                    ...
                                    <div class="modal-body">
                                        <div class="row">
                                            ...
                                            Operator SKPD 
                                                <div class="fs-7">
                                                    Diajukan pada {{ date('d-m-Y', strtotime($draft->tanggal_pengajuan))}} oleh {{$draft->user->name}}
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row mt-3">
                                            ...
                                            Admin FO 
                                                <div class="fs-7">
                                                    ...
                                                    {{$draft->draft_admins->status}} pada {{date('d-m-Y', strtotime($draft->draft_admins->updated_at))}}
                                                    @else
                                                    {{$draft->draft_admins->status}} pada {{date('d-m-Y', strtotime($draft->draft_admins->updated_at))}} oleh {{$draft->draft_admins->validated}}
                                                    @endif
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            Staff perundang undangan 
                                                <div class="fs-7">
                                                    @if(isset($draft->draft_admins->staffUndang->status))
                                                        ...
                                                        {{$draft->draft_admins->staffUndang->status}} pada {{date('d-m-Y', strtotime($draft->draft_admins->staffUndang->updated_at))}}
                                                        @else
                                                        {{$draft->draft_admins->staffUndang->status}} pada {{date('d-m-Y', strtotime($draft->draft_admins->staffUndang->updated_at))}} oleh {{$draft->draft_admins->staffUndang->validated}}
                                                        @endif
                                                    @endif
                                                </div>
                                            </div>
                                            ...
                                            Kasubag perundang undangan 
                                                <div class="fs-7">
                                                    @if(isset($draft->draft_admins->staffUndang->kasubagUndang->status))
                                                        ...
                                                        {{$draft->draft_admins->staffUndang->kasubagUndang->status}} pada {{date('d-m-Y', strtotime($draft->draft_admins->staffUndang->kasubagUndang->updated_at))}}
                                                        @else
                                                        {{$draft->draft_admins->staffUndang->kasubagUndang->status}} pada {{date('d-m-Y', strtotime($draft->draft_admins->staffUndang->kasubagUndang->updated_at))}} oleh {{$draft->draft_admins->staffUndang->kasubagUndang->validated}}
                                                        @endif
                                                    @endif
                                                </div>
                                            </div>
                                            ...
                                            Kabag
                                                <div class="fs-7">
                                                    @if(isset($draft->draft_admins->staffUndang->kasubagUndang->kabag->status))
                                                        ...
                                                        {{$draft->draft_admins->staffUndang->kasubagUndang->kabag->status}} pada {{date('d-m-Y', strtotime($draft->draft_admins->staffUndang->kasubagUndang->kabag->updated_at))}}
                                                        @else
                                                        {{$draft->draft_admins->staffUndang->kasubagUndang->kabag->status}} pada {{date('d-m-Y', strtotime($draft->draft_admins->staffUndang->kasubagUndang->kabag->updated_at))}} oleh {{$draft->draft_admins->staffUndang->kasubagUndang->kabag->validated}}
                                                        @endif
                                                    @endif
                                                </div>
                                            </div>
                                            ...
                                            Kepala Dinas
                                                <div class="fs-7">
                                                    @if(isset($draft->draft_admins->staffUndang->kasubagUndang->kabag->kepalaDinas->status))
                                                        ...
                                                        {{$draft->draft_admins->staffUndang->kasubagUndang->kabag->kepalaDinas->status}} pada {{date('d-m-Y', strtotime($draft->draft_admins->staffUndang->kasubagUndang->kabag->kepalaDinas->updated_at))}}
                                                        @else
                                                        {{$draft->draft_admins->staffUndang->kasubagUndang->kabag->kepalaDinas->status}} pada {{date('d-m-Y', strtotime($draft->draft_admins->staffUndang->kasubagUndang->kabag->kepalaDinas->updated_at))}} oleh {{$draft->draft_admins->staffUndang->kasubagUndang->kabag->kepalaDinas->validated}}
                                                        @endif
                                                    @endif
                                                </div>
                                            </div>
                                            ...
                                            Sekda
                                                <div class="fs-7">
                                                    @if(isset($draft->draft_admins->staffUndang->kasubagUndang->kabag->kepalaDinas->sekda->status))
                                                        ...
                                                        {{$draft->draft_admins->staffUndang->kasubagUndang->kabag->kepalaDinas->sekda->status}} pada {{date('d-m-Y', strtotime($draft->draft_admins->staffUndang->kasubagUndang->kabag->kepalaDinas->sekda->updated_at))}}
                                                        @else
                                                        {{$draft->draft_admins->staffUndang->kasubagUndang->kabag->kepalaDinas->sekda->status}} pada {{date('d-m-Y', strtotime($draft->draft_admins->staffUndang->kasubagUndang->kabag->kepalaDinas->sekda->updated_at))}} oleh {{$draft->draft_admins->staffUndang->kasubagUndang->kabag->kepalaDinas->sekda->validated}}
                                                        @endif
                                                    @endif
                                                </div>
                                            </div>
                                            ...
                                            Walikota
                                                <div class="fs-7">
                                                    @if(isset($draft->draft_admins->staffUndang->kasubagUndang->kabag->kepalaDinas->sekda->walikota->status))
                                                        ...
                                                        {{$draft->draft_admins->staffUndang->kasubagUndang->kabag->kepalaDinas->sekda->walikota->status}} pada {{date('d-m-Y', strtotime($draft->draft_admins->staffUndang->kasubagUndang->kabag->kepalaDinas->sekda->walikota->updated_at))}}
                                                        @else
                                                        {{$draft->draft_admins->staffUndang->kasubagUndang->kabag->kepalaDinas->sekda->walikota->status}} pada {{date('d-m-Y', strtotime($draft->draft_admins->staffUndang->kasubagUndang->kabag->kepalaDinas->sekda->walikota->updated_at))}} oleh {{$draft->draft_admins->staffUndang->kasubagUndang->kabag->kepalaDinas->sekda->walikota->validated}}
                                                        @endif
                                                    @endif
                                                </div>
                                            </div>
                                            ...
                                            Staff Dokumentasi
                                                <div class="fs-7">
                                                    @if(isset($draft->draft_admins->staffUndang->kasubagUndang->kabag->kepalaDinas->sekda->walikota->staffDokumentasi->walikota_id))
                                                        ...
                                                        {{$draft->draft_admins->staffUndang->kasubagUndang->kabag->kepalaDinas->sekda->walikota->staffDokumentasi->status}} pada {{date('d-m-Y', strtotime($draft->draft_admins->staffUndang->kasubagUndang->kabag->kepalaDinas->sekda->walikota->staffDokumentasi->updated_at))}}
                                                        @else
                                            ...
                                            Kasubag Dokumentasi
                                                <div class="fs-7">
                                                    @if(isset($draft->draft_admins->staffUndang->kasubagUndang->kabag->kepalaDinas->sekda->walikota->staffDokumentasi->produkHukum->status))
                                                        ...
                                                        {{$draft->draft_admins->staffUndang->kasubagUndang->kabag->kepalaDinas->sekda->walikota->staffDokumentasi->produkHukum->status}} pada {{date('d-m-Y', strtotime($draft->draft_admins->staffUndang->kasubagUndang->kabag->kepalaDinas->sekda->walikota->staffDokumentasi->produkHukum->updated_at))}}
                                                        @else
