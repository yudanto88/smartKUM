                                ...
                                <div class="modal-dialog">
                                    ...
                                    <div class="modal-body">
                                        <div class="row">
                                            ...
                                            Operator SKPD 
                                                <div class="fs-7">
                                                    Diajukan pada {{date('d-m-Y', strtotime($draft->admin->draft->tanggal_pengajuan))}} pukul {{date('H:i', strtotime($draft->admin->draft->created_at))}} oleh {{$draft->admin->draft->user->name}}
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row mt-3">
                                            ...
                                            Admin FO 
                                                <div class="fs-7">
                                                    ...
                                                    {{$draft->admin->status}} pada {{date('d-m-Y', strtotime($draft->admin->updated_at))}} pukul {{date('H:i', strtotime($draft->admin->updated_at))}}
                                                    @else
                                                    {{$draft->admin->status}} pada {{date('d-m-Y', strtotime($draft->admin->updated_at))}} pukul {{date('H:i', strtotime($draft->admin->updated_at))}} oleh {{$draft->admin->validated}}
                                                    @endif
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            Kabag
                                                <div class="fs-7">
                                                    @if(isset($draft->kasubagUndang->kabag->status))
                                                        ...
                                                        {{$draft->kasubagUndang->kabag->status}} pada {{date('d-m-Y', strtotime($draft->kasubagUndang->kabag->updated_at))}} pukul {{date('H:i', strtotime($draft->kasubagUndang->kabag->updated_at))}}
                                                        @else
                                                        {{$draft->kasubagUndang->kabag->status}} pada {{date('d-m-Y', strtotime($draft->kasubagUndang->kabag->updated_at))}} pukul {{date('H:i', strtotime($draft->kasubagUndang->kabag->updated_at))}} oleh {{$draft->kasubagUndang->kabag->validated}}
                                                        @endif
                                                    @endif
                                                </div>
                                            </div>
                                            ...
                                            Kepala Dinas
                                                <div class="fs-7">
                                                    @if(isset($draft->kasubagUndang->kabag->kepalaDinas->status))
                                                        ...
                                                        {{$draft->kasubagUndang->kabag->kepalaDinas->status}} pada {{date('d-m-Y', strtotime($draft->kasubagUndang->kabag->kepalaDinas->updated_at))}} pukul {{date('H:i', strtotime($draft->kasubagUndang->kabag->kepalaDinas->updated_at))}}
                                                        @else
                                                        {{$draft->kasubagUndang->kabag->kepalaDinas->status}} pada {{date('d-m-Y', strtotime($draft->kasubagUndang->kabag->kepalaDinas->updated_at))}} pukul {{date('H:i', strtotime($draft->kasubagUndang->kabag->kepalaDinas->updated_at))}} oleh {{$draft->kasubagUndang->kabag->kepalaDinas->validated}}
                                                        @endif
                                                    @endif
                                                </div>
                                            </div>
                                            ...
                                            Sekda
                                                <div class="fs-7">
                                                    @if(isset($draft->kasubagUndang->kabag->kepalaDinas->sekda->status))
                                                        ...
                                                        {{$draft->kasubagUndang->kabag->kepalaDinas->sekda->status}} pada {{date('d-m-Y', strtotime($draft->kasubagUndang->kabag->kepalaDinas->sekda->updated_at))}} pukul {{date('H:i', strtotime($draft->kasubagUndang->kabag->kepalaDinas->sekda->updated_at))}}
                                                        @else
                                                        {{$draft->kasubagUndang->kabag->kepalaDinas->sekda->status}} pada {{date('d-m-Y', strtotime($draft->kasubagUndang->kabag->kepalaDinas->sekda->updated_at))}} pukul {{date('H:i', strtotime($draft->kasubagUndang->kabag->kepalaDinas->sekda->updated_at))}} oleh {{$draft->kasubagUndang->kabag->kepalaDinas->sekda->validated}}
                                                        @endif
                                                    @endif
                                                </div>
                                            </div>
                                            ...
                                            Walikota
                                                <div class="fs-7">
                                                    @if(isset($draft->kasubagUndang->kabag->kepalaDinas->sekda->walikota->status))
                                                        ...
                                                        {{$draft->kasubagUndang->kabag->kepalaDinas->sekda->walikota->status}} pada {{date('d-m-Y', strtotime($draft->kasubagUndang->kabag->kepalaDinas->sekda->walikota->updated_at))}} pukul {{date('H:i', strtotime($draft->kasubagUndang->kabag->kepalaDinas->sekda->walikota->updated_at))}}
                                                        @else
                                                        {{$draft->kasubagUndang->kabag->kepalaDinas->sekda->walikota->status}} pada {{date('d-m-Y', strtotime($draft->kasubagUndang->kabag->kepalaDinas->sekda->walikota->updated_at))}} pukul {{date('H:i', strtotime($draft->kasubagUndang->kabag->kepalaDinas->sekda->walikota->updated_at))}} oleh {{$draft->kasubagUndang->kabag->kepalaDinas->sekda->walikota->validated}}
                                                        @endif
                                                    @endif
                                                </div>
                                            </div>
                                            ...
                                            Staff Dokumentasi
                                                <div class="fs-7">
                                                    @if(isset($draft->kasubagUndang->kabag->kepalaDinas->sekda->walikota->staffDokumentasi->walikota_id))
                                                        ...
                                                        {{$draft->kasubagUndang->kabag->kepalaDinas->sekda->walikota->staffDokumentasi->status}} pada {{date('d-m-Y', strtotime($draft->kasubagUndang->kabag->kepalaDinas->sekda->walikota->staffDokumentasi->updated_at))}} pukul {{date('H:i', strtotime($draft->kasubagUndang->kabag->kepalaDinas->sekda->walikota->staffDokumentasi->updated_at))}}
                                                        @else
                                                        {{$draft->kasubagUndang->kabag->kepalaDinas->sekda->walikota->staffDokumentasi->status}} pada {{date('d-m-Y', strtotime($draft->kasubagUndang->kabag->kepalaDinas->sekda->walikota->staffDokumentasi->updated_at))}} pukul {{date('H:i', strtotime($draft->kasubagUndang->kabag->kepalaDinas->sekda->walikota->staffDokumentasi->updated_at))}} oleh {{$draft->kasubagUndang->kabag->kepalaDinas->sekda->walikota->staffDokumentasi->validated}}
                                                        @endif
                                                    @endif
                                                </div>
                                            </div>
